...
export default function CreateMultiSigModal({
  ...
  const setCreateModal = flag => {
    setIsCreateModalVisible(flag);
  };
  ...
  return (
    <>
      <Button type="primary" style={{ marginRight: 10 }} onClick={e => setCreateModal(true)}>
        Create
      </Button>
      <Modal
        title="Create Multi-Sig Wallet"
        visible={isCreateModalVisible}
        onCancel={e => setCreateModal(false)}
        footer={[
          <Button key="back" onClick={e => setCreateModal(false)}>
            Cancel
          </Button>,
